(() => {
  ...
  // src/week3.js
  gsapWithCSS.registerPlugin(Observer, SplitText, ScrollTrigger2, CustomEase);
  window.Webflow ||= [];
  window.Webflow.push(() => {
    ...
    gsapWithCSS.to("#spinner1", {
      rotation: 360,
      duration: 2,
      ease: "none",
      repeat: -1
    });
    gsapWithCSS.to("#spinner2", {
      rotation: 360,
      duration: 2,
    ...
    document.getElementById("btn-cart").addEventListener("click", function() {
      ...
      const cartAnimation = gsapWithCSS.timeline();
      cartAnimation.to(cartImage, {
        y: -15,
        duration: 0.3,
        ease: "power2.out"
      }).to(
    ...
    const formErrorTimeline = gsapWithCSS.timeline({ paused: true });
    formErrorTimeline.to(".form_component", {
      x: -10,
      rotation: -2,
      duration: 0.1,
      ease: "power2.out"
    ...
    document.fonts.ready.then(function() {
      ...
      if (preloader) {
        ...
        gsapWithCSS.set(cover, { display: "none" });
        preloaderAnimation.from(".preloader_bg-line", {
          scaleX: 0,
